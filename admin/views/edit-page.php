...
<html lang="en">
  ...
  <body>
    <div class="container">
      <form onsubmit="return validate();" class="form-horizontal center-div" novalidate="novalidate" role="form" method="post" action="../controllers/manager.php?request=editpages&row_id=<?php echo $row_id ?>">
        ...
        <div class="form-group"> 
          <div class="row col-sm-10">
            ...
            <div class="col-sm-offset-2 col-sm-2 hand-button">
              <a id="cancel-button" class="btn btn-large btn-warning" role="button" href="page-manager.php">Cancel</a>
            </div>
          </div>
        </div>
      </form>
