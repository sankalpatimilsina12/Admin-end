...
<?php
  ...
  $db = new Connect;
  $row_id = $_GET['row_id'];
  $query = "SELECT title, description FROM slides WHERE id=$row_id";
    ...
    <div class="container-fluid">
      ...
      <nav class="navbar navbar-toggleable-md">
        ...
        <div class="collapse navbar-collapse flex-column side-nav" id="navbarSupportedContent">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo $site_url ?>/admin/views/slider-manager.php"><i class="fa fa-sliders" aria-hidden="true"></i>&nbsp;Slider Manager</a>
          </li>
          <li class="nav-item">
      ...
      <div class="right-container" style="padding: 2%">
        ...
        <form onsubmit="return validate();" class="form-horizontal" novalidate="novalidate" role="form" method="post" action="<?php echo $site_url; ?>/admin/controllers/manager.php?request=editslide&row_id=<?php echo $row_id ?>" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-12">
              <input class="form-control" id="text" name="description" value="<?php echo $row[0][1]; ?>">
          ...
          <div class="form-group">
            <div class="col-sm-12">
              <label class="btn btn-primary" style="width: 100%">
                  <span id="add-image">Change Image</span><input id="file" name="fileToUpload" type="file" style="display: none;">
              </label>
            </div>
          </div>
          <div class="form-group"> 
            <div class="row" style="padding: 1%">
              ...
              <div class="col-sm-6">
                <a id="cancel-button" class="btn btn-warning" style="width: 100%" role="button" href="<?php echo $site_url; ?>/admin/views/slider-manager.php">Cancel</a>
              </div>
            </div>
          </div>
        </form>
