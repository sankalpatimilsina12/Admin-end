<html lang="en">
  ...
  <body>
    <div class="container">
      <form class="form-horizontal center-div" onsubmit="return validate();" novalidate="novalidate" role="form" method="post" action="../controllers/manager.php?request=create-user">
