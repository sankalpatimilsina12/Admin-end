...
<html lang="en">
  ...
  <body>
    <div class="container">
      <form class="form-horizontal center-div" onsubmit="return validate();" novalidate="novalidate" role="form" method="post" action="admin-manager.php?request=update-user&row_id=<?php echo $row_id ?>">
